...
[Overview of the Physical Layer - Wetherall_2.1](https://mediaplayer.pearsoncmg.com/_ph_cc_ecs_set.title.2-1_Overview_of_the_Physical_Layer__/ph/streaming/esm/tanenbaum5e_videonotes/2_1_physical_overview_cn5e.m4v)
...
## 2.2. Vezetékes átviteli közegek {#2.2}
...
### 2.2.3. Koaxiális kábel (coaxial cable) {#2.2.3}
...
* Ha az üvegszál átmérőjét néhány fényhullámhossznyira csökkentjük -> hullámvezetőként viselkedik, a fény visszaverődés nélkül, egyenes vonal mentén tejed a vezetékben -> **egymódusú szál**. Drágább, de nagyobb távolság
...
### 2.5.3. Frekvenciaosztásos multiplexelés {#2.5.3}
