...
|[3.1. A fájlrendszer](#31-a-fájlrendszer-31) |  [3.2. A csereterület](#32-a-csereterület) |
|---|---|
|[3.1.1. Standard jegyzékszerkezet](#311-standard-jegyzékszerkezet) | |
|[3.1.2. Fájlokról részletesebben](#312-fájlokról-részletesebben) | |
|[3.1.3. Helyettesítő karakterek](#313-helyettesítő-karakterek) | |
|[3.1.4. Fontosabb parancsok](#314-fontosabb-parancsok) | |
|[3.1.5. A Linux fő fájlrendszerei](#315-linux-fő-fájlrendszerei) | |
|[3.1.6. Linkek](#316-linkek) | |
|[3.1.7. A /proc fájlrendszer](#317-a-proc-fájlrendszer) | |
|[3.1.8. Fájlrendszer csatolása](#318-fájlrendszer-létrehozása) | |
