...
|[3.1. A fájlrendszer](#31-a-fájlrendszer-31) |  [3.2. A csereterület](#32-a-csereterület) | [3.3. Az fstab fájl](#33-az-fstab-fájl) |
|[3.4. A fájlrendszer épségének ellenőrzése](#34-a-fájlrendszer-épségének-ellenőrzése) | [3.5. Chroot](#35-chroot) | |
